...
Enter the roll number you want to find39

Record found
	Enter Roll Number : 67

	Enter the Name : venky
...
Enter the name you want to find and editabhishek

Name found
	Enter Roll Number : 47

	Enter the Name : safaya
...
6.Search & edit(only name)
 ...
 8.Exit
	Enter the Choice	:7
Please Enter the Roll No. of Student Whose Info You Want to Delete: 67
The record with the roll no. 67 has been deleted 
